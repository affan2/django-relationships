...
latex_documents = [
  ('index', 'django-relationships.tex', 'django-relationships Documentation',
...
man_pages = [
    ('index', 'django-relationships', 'django-relationships Documentation',
     ['charles leifer'], 1)
]
